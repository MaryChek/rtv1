...
{
	if (type == SPH)
		return (object->sph_objs[index].color);
	else if (type == CYLINDER)
		return (object->cyln_objs[index].color);
	else if (type == CONE)
		return (object->cone_objs[index].color);
	else
		return (object->plane_objs[index].color);
}

int			get_specul_obj(t_object *object, int type, int index)
{
	if (type == SPH)
		return (object->sph_objs[index].specular);
	else if (type == CYLINDER)
		return (object->cyln_objs[index].specular);
	else if (type == CONE)
		return (object->cone_objs[index].specular);
	else
		return (object->plane_objs[index].specular);
}
